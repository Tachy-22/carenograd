...
export async function middleware(request: NextRequest) {
  ...
  if (
    ...
    pathname.startsWith('/admin') || // Completely bypass middleware for admin routes
    pathname.includes('.') ||
...
// Google → Frontend :3001/auth/google/callback → Backend :3000/auth/google/callback → Frontend /auth/callback